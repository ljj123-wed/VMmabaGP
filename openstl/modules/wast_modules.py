...
if __name__ == "__main__":
    ...
    model = WaST_level1(in_shape=(10, 1, 128, 128), encoder_dim=5, block_list=[2, 8, 2]).cuda()
    model1 = SimVP_Model(in_shape=(10, 1, 128, 128)).cuda()

    # dummy_tensor = torch.rand(1, 4, 2, 32, 32).cuda()
    # output = model(dummy_tensor)
    flops, params = get_model_complexity_info(model, (10, 1, 128, 128), as_strings=True, print_per_layer_stat=True)
    flops1, params1 = get_model_complexity_info(model1, (10, 1, 128, 128), as_strings=True, print_per_layer_stat=True)
    print(flops, params)
